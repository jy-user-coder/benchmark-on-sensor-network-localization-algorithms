...
G = snl_case(anchors, sensors, r, is_relaxed=True)
...
class test_snl_case(unittest.TestCase):
    ...
    def test_solver(self):
        ...
        x_ans, wk, jac = utils.GALP(F, gradF, h1, gradh1, x0, optimizer='scs',\
                        indices=G.indices, epochs=50, sub_method='scs', tol=10**(-6), sigma=0.00001, is_exact=True, eps=10**(-4))
